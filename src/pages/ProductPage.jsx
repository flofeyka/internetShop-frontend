    ...
    <form onSubmit={handleSubmit(onSubmit)} className={"h-[100%] flex sm:flex-col"}>
      <Modal isOpen={modal} onOpenChange={setModal}>
        <ModalContent className="p-5">
          ...
          <div className="text-xl select-none">
            Напишите: "Я действительно хочу удалить этот товар."
          </div>
          <div className="">
            <Input
              size="lg"
          ...
          <Link to="/myProducts">
            <Button
              disabled={
                modalValue !== "Я действительно хочу удалить этот товар."
              }
              color={
                modalValue === "Я действительно хочу удалить этот товар."
                  ? "danger"
      ...
      <div className="lg:ml-5">
        ...
        >
            ...
            {productCartFound ? (
              <div className={"flex w-full items-center"}>
                ...
                <Button
                  ...
                  size={"lg"}
                  variant={"faded"}
                  onClick={() => dispatch(deleteOneFromCart(productData.id))}
                >
                  В корзине
                </Button>
              </div>
              ...
              <div className={"flex w-full"}>
                <Button
                  ...
                  type="button"
                  color={"primary"}
                  onClick={() => dispatch(addOneToCart(productData.id))}
                >
                  В корзину
                </Button>
              </div>
          ...
          <div className={"mt-2"}>
            {favouriteList.find((i) => i.id === productData.id) ? (
              <Button
